//
//  TrainCityChoiceTableViewController.m
//  UCAI
//
...
@implementation TrainCityChoiceTableViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    switch (_cityType) {
        case 1:
            self.trainSearchViewController.startCityLabel.text = [[citySection objectAtIndex:indexPath.row] objectAtIndex:0];
            break;
        case 2:
            self.trainSearchViewController.arrivalCityLabel.text = [[citySection objectAtIndex:indexPath.row] objectAtIndex:0];
            break;
    }
...
//    WQAdView *adview = [[[WQAdView alloc] init] autorelease];
//    [adview setFrame:CGRectMake(0, 366, self.view.frame.size.width, 50)];
