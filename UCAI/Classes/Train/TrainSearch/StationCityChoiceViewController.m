//
//  StationCityChoiceViewController.m
//  UCAI
//
...
@interface StationCityChoiceViewController ()

@end

@implementation StationCityChoiceViewController
@synthesize citys = _citys;
@synthesize filteredCitys = _filteredCitys;
@synthesize keys = _keys;
@synthesize filteredKeys = _filteredKeys;
@synthesize searchController = _searchController;
@synthesize stationViewContrller=_stationViewContrller;
...
- (void)dealloc {
    ...
    [self.stationViewContrller release];
    [super dealloc];
}

- (StationCityChoiceViewController *)init {
    self = [super init];
    return self;
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    self.stationViewContrller.lblStationName.text = [[citySection objectAtIndex:indexPath.row] objectAtIndex:0];
    self.stationViewContrller.stationName = [[citySection objectAtIndex:indexPath.row] objectAtIndex:0];;
