//
//  FlightCitySettingChoiceTableViewController.m
//  UCAI
//
...
@implementation FlightCitySettingChoiceTableViewController
...
- (void)viewDidLoad {
    ...
    switch (_cityType) {
        case 1:
            self.title = @"选择航班默认出发城市";
            break;
            
        case 2:
            self.title = @"选择航班默认目的城市";
            break;
    }
    ...
    NSString *path = [PiosaFileManager ucaiResourcesBoundleDicFilePath:@"flightCity" inDirectory:nil];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    switch (_cityType) {
        case 1:
            [userDefaults setValue:[[citySection objectAtIndex:indexPath.row] objectAtIndex:0] forKey:@"flightDefaultStartedCityName"];
            [userDefaults setValue:[[citySection objectAtIndex:indexPath.row] objectAtIndex:1] forKey:@"flightDefaultStartedCityCode"];
            break;
        case 2:
            [userDefaults setValue:[[citySection objectAtIndex:indexPath.row] objectAtIndex:0] forKey:@"flightDefaultArrivedCityName"];
            [userDefaults setValue:[[citySection objectAtIndex:indexPath.row] objectAtIndex:1] forKey:@"flightDefaultArrivedCityCode"];
            break;
    }
