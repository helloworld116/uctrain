//
//  WeatherCitySettingChoiceTableViewController.m
//  UCAI
//
...
@implementation WeatherCitySettingChoiceTableViewController
...
- (void)viewDidLoad {
    ...
    NSString *path = [PiosaFileManager ucaiResourcesBoundleDicFilePath:@"weatherCity" inDirectory:nil];
    ...
    for (NSString * keyString in self.keys) {
        ...
        for (NSArray *city in citys) {
            if ([[city objectAtIndex:0] compare:searchString options:(NSCaseInsensitiveSearch|NSDiacriticInsensitiveSearch) range:NSMakeRange(0, [searchString length])] == NSOrderedSame
                || [[city objectAtIndex:1] compare:searchString options:(NSCaseInsensitiveSearch|NSDiacriticInsensitiveSearch) range:NSMakeRange(0, [searchString length])] == NSOrderedSame)
			{
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [userDefaults setValue:[[citySection objectAtIndex:indexPath.row] objectAtIndex:0] forKey:@"weatherDefaultCityName"];
    [userDefaults setValue:[NSString stringWithFormat:@"%.f",[[[citySection objectAtIndex:indexPath.row] objectAtIndex:2] floatValue]*1000000] forKey:@"weatherDefaultCityLat"];
    [userDefaults setValue:[NSString stringWithFormat:@"%.f",[[[citySection objectAtIndex:indexPath.row] objectAtIndex:3] floatValue]*1000000] forKey:@"weatherDefaultCityLng"];
    [userDefaults setValue:[[citySection objectAtIndex:indexPath.row] objectAtIndex:4] forKey:@"weatherDefaultProvinceName"];
