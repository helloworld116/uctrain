//
//  TrainCitySettingChoiceTableViewController.m
//  UCAI
//
...
@implementation TrainCitySettingChoiceTableViewController
...
- (TrainCitySettingChoiceTableViewController *)initWithCityType:(NSUInteger)cityType andStyle:(UITableViewStyle) tableViewStyle{
...
- (void)viewDidLoad {
    ...
    switch (_cityType) {
        case 1:
            self.title = @"选择列车默认出发城市";
            break;
            
        case 2:
            self.title = @"选择列车默认目的城市";
            break;
    }
    ...
    NSString *path = [PiosaFileManager ucaiResourcesBoundleDicFilePath:@"trainCity" inDirectory:nil];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    switch (_cityType) {
        case 1:
            [userDefaults setValue:[[citySection objectAtIndex:indexPath.row] objectAtIndex:0] forKey:@"trainDefaultStartedCityName"];
            break;
        case 2:
            [userDefaults setValue:[[citySection objectAtIndex:indexPath.row] objectAtIndex:0] forKey:@"trainDefaultArrivedCityName"];
            break;
    }
